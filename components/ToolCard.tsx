    ...
    <Link href={tool.href}>
      <Card className='card-style cursor-pointer overflow-hidden h-full group'>
        <CardHeader className='space-y-4 p-6'>
          ...
          <div>
            <CardTitle className='text-gray-900 text-lg font-bold mb-2 group-hover:text-main transition-colors'>{name}</CardTitle>
            <CardDescription className='text-gray-500 text-sm leading-relaxed'>{description}</CardDescription>
          </div>
        </CardHeader>
      </Card>
    </Link>
